...
@Component({
  selector: 'app-rzethon',
  templateUrl: './rzethon.component.html',
  styleUrls: ['./rzethon.component.scss']
})
export class RzethonComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit(): void {
    (document.getElementById('navigator') as HTMLElement).classList.add('navigator-rzethon');
    (document.getElementById('navigator-menu') as HTMLElement).classList.add('navigator-menu-rzethon');
    document.documentElement.style.setProperty('--swiper-theme-color', '#ffffff');
    document.documentElement.classList.add('rzethon-scrollbar');
    window.scrollTo(0, 0);
  ...
  ngOnDestroy(): void {
    (document.getElementById('navigator') as HTMLElement).classList.remove('navigator-rzethon');
    (document.getElementById('navigator-menu') as HTMLElement).classList.remove('navigator-menu-rzethon');

    document.documentElement.classList.remove('rzethon-scrollbar');
  }
